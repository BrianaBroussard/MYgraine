...
with app.app_context():
   ...
   #Returns list of tuples with all user's name and phone number
    ...
    query = User.query.filter(User.email == "+19498387000").all() #test query
    ...
    for users in users_phone_scheduled_reminder: 
        ...
        send_when = date.today().isoformat() + users[2].isoformat() #+ '-08:00' #formats time and adjusts for local timezone with -08:00 
